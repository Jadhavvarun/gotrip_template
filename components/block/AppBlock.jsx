  ...
  return (
    <>
      ...
      <p className="text-dark-1 pr-40 lg:pr-0 mt-15 sm:mt-5">
        Book in advance or last-minute with Frankfort With Kids. Receive instant
        confirmation. Access your booking info offline.
      </p>

      <div className="row items-center pt-30 sm:pt-10">
        <div className="col-auto">
          <div className="d-flex items-center px-20 py-10 rounded-8 border-white-15 text-white bg-yellow-1">
            <div className="icon-apple text-24 text-black" />
            <div className="ml-20">
              <div className="text-14 text-black">Download on the</div>
              <div className="text-15 lh-1 fw-500 text-black">Apple Store</div>
            </div>
          </div>
        </div>
        {/* End .col */}
