...
const Index = () => {
  ...
  return (
    <section className="masthead -type-2 z-2 bg-floral-white">
      <div className="masthead__bg bg-dark-3">
        <img alt="image" src="/img/masthead/2/teal.png" className="js-lazy" />
      </div>
      {/* End bg image */}
          ...
          <div className="row y-gap-40">
            <div className="col-xl-5" data-aos="fade-up" data-aos-offset="0">
              <h1 className="z-2 text-60 lg:text-40 md:text-30 text-white pt-80 xl:pt-0">
                <span className="text-yellow-1">Each day is a new chance to make</span>
                <br />
                a difference.
              </h1>
