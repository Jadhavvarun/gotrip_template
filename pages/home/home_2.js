...
const home_2 = () => {
  return (
    <>
      ...
      {/* <section className="layout-pt-lg layout-pb-md bg-floral-white">
      ...
      <section className="layout-pt-md layout-pb-md bg-floral-white">
        <div className="container">
      ...
      <section className="layout-pt-md layout-pb-lg bg-floral-white">
        <div className="container">
          <div className="row y-gap-10 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Ideas for Weekend</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
      ...
      <section className="layout-pt-lg layout-pb-lg bg-skin-1">
        <div className="container">
        ...
        <div className="container">
          <div className="row justify-center text-center">
            <div className="col-auto">  
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">
                  Get inspiration for your kids next activity.....
                </h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
